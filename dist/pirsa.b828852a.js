...
},{"./utils/jquery":"l94D0","./components/header":"fes7L"}],"l94D0":[function(require,module,exports,__globalThis) {
...
$(document).ready(function() {
    ...
    $('html').click(function(event1) {
        if ($(event1.target).closest(translateButton, translateMenu).length === 0) closeMenu(translateButton, translateMenu);
    });
    initTranslateMobile();
});
function initTranslateMobile() {
    $('.translate-mobile .nsw-form__select').on('mousedown', function(event1) {
