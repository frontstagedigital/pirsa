...
var _jquery = require("./utils/jquery");
var _header = require("./components/header");
var _sideNav = require("./components/side-nav");
var _inPageNav = require("./components/in-page-nav");
var _videoBannerControls = require("./components/video-banner-controls");
var _downloadPdf = require("./components/download-pdf");

},{"./utils/jquery":"l94D0","./components/header":"fes7L","./components/side-nav":"aBFC8","./components/in-page-nav":"2Bdwy","./components/video-banner-controls":"jhdoO","./components/download-pdf":"4g62A"}],"l94D0":[function(require,module,exports,__globalThis) {
...
},{"jquery":"dlwdd","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dlwdd":[function(require,module,exports,__globalThis) {
/*!
...
},{}],"fes7L":[function(require,module,exports,__globalThis) {
$(document).ready(function() {
    ...
    $('html').click(function(event) {
        if ($(event.target).closest(translateButton, translateMenu).length === 0) closeMenu(translateButton, translateMenu);
    });
    initTranslateMobile();
});
function initTranslateMobile() {
    ...
    $('html').on('click', function(event) {
        ...
        if (!$(event.target).closest('.translate-mobile').length && $('.translate-mobile').hasClass('active')) $('.translate-mobile').removeClass('active');
    });
}
...
},{}],"aBFC8":[function(require,module,exports,__globalThis) {
function sideNavAccordionMobile(windowmobile) {
    if (windowmobile.matches) {
        ...
        if (sideNav) {
            ...
            if (typeof sideNavHeader !== 'undefined') sideNavHeader.addEventListener('click', function(e) {
                e.preventDefault();
                this.classList.toggle('active');
                if (this.classList.contains('active')) sideNav.classList.add('nsw-side-nav--accordion-mobile-open');
                else sideNav.classList.remove('nsw-side-nav--accordion-mobile-open');
            });
        }
    }
}
...
},{}],"2Bdwy":[function(require,module,exports,__globalThis) {
...
function messageVideoiFrame(vidFunc, vidID, vidSrc) {
    ...
    if (vidSrc == 'youtube') {
        if (videoiFrameFunc == 'play') videoiFrameFunc = 'playVideo';
        else if (videoiFrameFunc == 'pause') videoiFrameFunc = 'pauseVideo';
        videoiFrame.postMessage('{"event":"command","func":"' + videoiFrameFunc + '","args":""}', "*");
    }
    if (vidSrc == 'vimeo') videoiFrame.postMessage('{"method":"' + videoiFrameFunc + '","args":""}', "*");
    if (vidSrc == 'video') {
        const videoEl = document.getElementById(vidID);
        if (videoiFrameFunc == 'play') videoEl.play();
        else if (videoiFrameFunc == 'pause') videoEl.pause();
    }
}
let playpauseButtons = document.getElementsByClassName("js-video-button__playpause");
for (let playpauseButton of playpauseButtons)playpauseButton.addEventListener("click", function() {
    ...
    if (buttonState == "pause") {
        ...
        if (buttonType == 'material') this.innerHTML = "play_arrow";
        ...
        if (buttonType == 'material') this.innerHTML = "pause";
        else this.innerHTML = "Pause";
    }
});

},{}],"4g62A":[function(require,module,exports,__globalThis) {
class DownloadPDF {
    constructor(element){
    ...
    init() {
        ...
        this.element.addEventListener('keyup', (event)=>{
            if (event.code && event.code.toLowerCase() === 'enter' || event.key && event.key.toLowerCase() === 'enter') this.downloadEvent();
        });
    }
    downloadEvent() {
...
if (downloadPDF) downloadPDF.forEach((element)=>{
    new DownloadPDF(element).init();
});

},{}]},["56AJI","lhpGb"], "lhpGb", "parcelRequire54eb")

//# sourceMappingURL=pirsa.b828852a.js.map
